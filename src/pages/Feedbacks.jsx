...
function Feedbacks() {
  ...
  return (
    <div className="w-screen md:px-[40px] md:pt-[56px] md:pb-[113px]">
      <HeaderFeedbacks
        showMenu={showMenu}
      ...
      >
        ...
        />
        <div className="px-6 pt-8 pb-[55px] md:px-0 md:pt-6 md:pb-0 flex flex-col items-center gap-y-4 w-full">
          ...
          {sortedFeedbacks && sortedFeedbacks.length === 0 ? (
            ...
            sortedFeedbacks.map((feedback) => (
              <Link to={`/feedbackDetails/${feedback.id}`} key={feedback.id}>
                <div className="md:w-screen md:px-[40px]">
                  <div
                    ...
                    <div className="md:flex md:flex-start md:gap-x-[40px]">
                      {feedback.upvotes ? (
                        <button
                          ...
                          md:flex md:flex-col items-center rounded-[10px] md:w-[45px] w-[69px] text-blue-50 text-[13px] font-bold"
                        >
